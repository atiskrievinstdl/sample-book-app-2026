...
def test(String environment){
    ...
    def directory = pwd()
    sh "echo '${directory}'"
    sh "docker run --rm --network sample-book-app-compose-network -v '${directory}'/test-reports:/api-tests/mochawesome-report atiskrievinstdl/api-tests books BOOK_ ${environment}"
